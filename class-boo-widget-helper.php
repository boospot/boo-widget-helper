 ...
 * Boo_Widget_Helper
 *
 * This is widget helper class, Most of the code is taken from Woocommerce plugin.
 *
 * @version 1.0
 *
			...
			foreach ( $this->settings as $key => $setting ) {
				...
				switch ( $setting['type'] ) {
					case 'number':
						...
						break;
					case 'url':
						$instance[ $key ] = isset( $new_instance[ $key ] ) ? esc_url_raw( $new_instance[ $key ] ) : $setting['std'];
						break;
					case 'textarea':
					...
					case 'checkbox':
						...
						break;
					case 'color':
						$instance[ $key ] = isset( $new_instance[ $key ] ) ? sanitize_hex_color( $new_instance[ $key ] ) : $setting['std'];
						break;
					default:
